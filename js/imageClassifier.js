...
function setup() {
  ...
  fwdButton.style('margin-top', '190px');
  fwdButton.style('margin-left', '500px');
  fwdButton.mousePressed(function() {
    classifier.addImage('forward');
    // debugger
  })
  ...
  rrButton.style('margin-top', '283px');
  rrButton.style('margin-left', '632px');
  rrButton.style('transform', 'skewY(10deg)');
  ...
  rlButton.style('margin-top', '281px');
  rlButton.style('margin-left', '378px');
  rlButton.style('transform', 'skewY(-10deg)');
  ...
  neutButton.style('margin-top', '270px');
  neutButton.style('margin-left', '502px');
  ...
  trainButton.style('margin-top', '177px');
  trainButton.style('margin-left', '354px');
